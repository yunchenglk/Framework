...
namespace YunChengLK.Framework.Data.Core
{
    ...
    public static class Entity<T>
    {
        ...
        static void initialization()
        {
            ...
            TableAttribute tableAttribute = Attribute.GetCustomAttribute(EntityType, typeof(TableAttribute), true) as TableAttribute;
            TableName = (tableAttribute != null) ? tableAttribute.Name : EntityType.Name;
